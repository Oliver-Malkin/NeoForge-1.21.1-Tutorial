package net.omalkin.tutorialmod.entity.client;
...
import net.omalkin.tutorialmod.entity.custom.GeckoVariant;
    ...
    private static final Map<GeckoVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(GeckoVariant.class), map -> {
                map.put(GeckoVariant.BLUE,
                        ResourceLocation.fromNamespaceAndPath(TutorialMod.MODID, "textures/entity/gecko/gecko_blue.png"));
                map.put(GeckoVariant.GREEN,
                        ResourceLocation.fromNamespaceAndPath(TutorialMod.MODID,"textures/entity/gecko/gecko_green.png"));
                map.put(GeckoVariant.PINK,
                        ResourceLocation.fromNamespaceAndPath(TutorialMod.MODID,"textures/entity/gecko/gecko_pink.png"));
                map.put(GeckoVariant.BROWN,
                        ResourceLocation.fromNamespaceAndPath(TutorialMod.MODID,"textures/entity/gecko/gecko_brown.png"));
            });
