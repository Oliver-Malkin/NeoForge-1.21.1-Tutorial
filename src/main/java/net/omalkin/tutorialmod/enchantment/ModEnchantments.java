package net.omalkin.tutorialmod.enchantment;
...
import net.omalkin.tutorialmod.enchantment.custom.LightningStrikeEnchantmentEffect;

public class ModEnchantments {
    public static final ResourceKey<Enchantment> LIGHTNING_STRIKER = ResourceKey.create(Registries.ENCHANTMENT,
            ResourceLocation.fromNamespaceAndPath(TutorialMod.MODID, "lightning_striker"));
