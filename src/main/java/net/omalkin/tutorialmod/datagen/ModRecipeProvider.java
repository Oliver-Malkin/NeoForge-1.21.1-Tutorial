...
public class ModRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes(RecipeOutput recipeOutput) {
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModItems.BISMUTH.get(), 18)
                ...
                .save(recipeOutput, "tutorialmod:bismuth_from_magic_block"); // Set the ID string when the OUTPUT of one recipe is used in another
        ...
        trimSmithing(recipeOutput, ModItems.KAUPEN_SMITHING_TEMPLATE.get(), ResourceLocation.fromNamespaceAndPath(TutorialMod.MODID, "kaupen"));
    }

    // Custom methods to generate the recipes in the correct namespace
