package net.omalkin.tutorialmod.screen.custom;
...
public class GrowthChamberMenu extends AbstractContainerMenu {
    ...
    public GrowthChamberMenu(int containerId, Inventory inventory, BlockEntity entity, ContainerData data) {
    ...
    // This is the shift click method
