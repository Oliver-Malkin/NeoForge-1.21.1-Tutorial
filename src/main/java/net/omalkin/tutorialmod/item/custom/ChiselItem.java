...
public class ChiselItem extends Item {
    // This is the map used to define what blocks are being changed
    ...
    // This is the constructor to make the actual item
    public ChiselItem(Properties properties) {
        super(properties);
    }

    // Lots of different methods for items that can be overridden, this one is the on use
    @Override
